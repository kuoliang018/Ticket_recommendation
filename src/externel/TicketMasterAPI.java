...
public class TicketMasterAPI {
	//https-protocol security; hostname;port; endpoint?query
	private static final String URL = "https://app.ticketmaster.com/discovery/v2/events.json";
	private static final String DEFAULT_KEYWORD = "";
	private static final String API_KEY = "v9Vrpokfqzjy7NIMz1n5ndYuupef4jl8";
	...
	public List<Item> search (double lat, double lon, String keyword) {
		...
		//using encoded location as location
		String query = String.format("apikey=%s&geoPoint=%s&keyword=%s&radius=50", API_KEY, geoHash, keyword);
		
		try {
			
			//Create a URLConnection instance that represents a connection to 
			//the remote object referred to by the URL. 
			
			//format url connection
			HttpURLConnection connection = (HttpURLConnection)new URL(URL + "?" + query).openConnection();
			connection.setRequestMethod("GET");//set connection's request as get
